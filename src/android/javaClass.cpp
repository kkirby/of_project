...
/*static*/ jmethodID JavaClass::getStaticMethodID(jclass clazz,const char* name,const char* signature){
	return ofGetJNIEnv()->GetStaticMethodID(clazz,name,signature);
}

/*static*/ jmethodID JavaClass::getStaticMethodID(jclass clazz,const char* name,const char* params,const char* returnType){
	return JavaClass::getStaticMethodID(clazz,name,JavaClass::createSignature(params,returnType));
}

//--- With object

/*static*/ jmethodID JavaClass::getStaticMethodID(jobject object,const char* name,const char* signature){
	return JavaClass::getStaticMethodID(ofGetJNIEnv()->GetObjectClass(object),name,signature);
}

/*static*/ jmethodID JavaClass::getStaticMethodID(jobject object,const char* name,const char* params,const char* returnType){
	return JavaClass::getStaticMethodID(ofGetJNIEnv()->GetObjectClass(object),name,params,returnType);
}
